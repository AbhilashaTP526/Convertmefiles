...
export const metadata: Metadata = {
  ...
  description: "Convert images between JPG, PNG, WebP, GIF, and BMP — free, private, and instant, right in your browser.",
  ...
  return (
    <Container className="py-12">
      ...
      <p className="mt-3 max-w-2xl text-lg text-zinc-600">
        Convert between JPG, PNG, WebP, GIF, and BMP. All conversions run locally in your browser — no upload
        required.
      </p>
